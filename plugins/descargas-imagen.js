...
if (!text) throw `️${lenguajeGB['smsAvisoMG']()}${mid.smsMalused7} *${usedPrefix + command} Dipak*`
...
let link = image
conn.sendButton(m.chat, `💞 ${mid.buscador}: ${text}`, wm, link, [['🔄 𝙉𝙚𝙭𝙩 | 𝙉𝙚𝙭𝙩', `/imagen ${text}`]], null, null, m)
